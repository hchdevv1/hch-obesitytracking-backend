...
export class SuccessPatientItemDto {
  @ApiProperty({
    example: '66',
  ...
  @ApiProperty({
    example: 6,
    description: 'น้ำหนักที่ลดลงจาก Baseline (kg)',
  })
  weightLost!: number;

  @ApiProperty({
    example: 6.9,
    description: 'เปอร์เซ็นต์น้ำหนักที่ลดลงจาก Baseline (%)',
  })
  weightLossPercent!: number;

  @ApiProperty({
    example: 0,
    description: 'น้ำหนักที่เหลือเพื่อให้ถึงเป้าหมาย (kg)',
  })
